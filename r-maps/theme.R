custom_theme_print <- function (base_size = 11,
                                ...
                                base_rect_size = 0.5)
{
  ...
  ggplot2::theme(
    ...
    axis.title.y = ggplot2::element_text(angle = 90L, margin = ggplot2::margin(r = 8L)),
    axis.title.x.top = NULL,
    axis.title.y.right = NULL,
    axis.ticks = ggplot2::element_line(),
    axis.ticks.length = ggplot2::unit(4L, "pt"),
    axis.ticks.length.x = ggplot2::unit(4L,
                                        "pt"),
    axis.ticks.length.x.top = ggplot2::unit(4L,
                                            "pt"),
    axis.ticks.length.x.bottom = ggplot2::unit(4L,
                                               "pt"),
    axis.ticks.length.y = ggplot2::unit(4L, "pt"),
    axis.ticks.length.y.left = ggplot2::unit(4L, "pt"),
    axis.ticks.length.y.right = ggplot2::unit(4L,
                                              "pt"),
    ...
    legend.spacing = ggplot2::unit(20L,
                                   "pt"),
    ...
    strip.text.x = ggplot2::element_text(margin = ggplot2::margin(t = 4.5,
                                                                  b = 4.5)),
    ...
    strip.switch.pad.grid = ggplot2::unit(0.1,
                                          "cm"),
    strip.switch.pad.wrap = ggplot2::unit(0.1,
                                          "cm"),
    complete = TRUE
  )
}

custom_theme_map <- function (scale = "continuous",
          base_size = 12,
          base_family = "Adobe Caslon Pro",
          base_line_size = 0.5,
          base_rect_size = 0.5)
