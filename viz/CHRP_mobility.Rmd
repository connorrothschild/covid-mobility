...
# load ACS data
ACS_econ <- read.csv("/Users/rebeccafrancis23/Documents/CHRP/covid-mobility/data/demographics/ACS_ECONOMIC_2018.csv",stringsAsFactors=FALSE)
ACS_social <- read.csv("/Users/rebeccafrancis23/Documents/CHRP/covid-mobility/data/demographics/ACS_SOCIAL_2018.csv",stringsAsFactors=FALSE)
...
county_cases <- read.csv("/Users/rebeccafrancis23/Documents/CHRP/covid-mobility/data/cases/us-counties-cases.csv")
state_cases <- read.csv("/Users/rebeccafrancis23/Documents/CHRP/covid-mobility/data/cases/us-states-cases.csv")
...
# laod SVI CDC data
SVI_dat <- read.csv("/Users/rebeccafrancis23/Documents/CHRP/covid-mobility/data/demographics/SVI2018_US_COUNTY.csv")

# load mobility data
mobility <- read.csv("/Users/rebeccafrancis23/Documents/CHRP/covid-mobility/data/mobility/county/county-data-wide-cleaned.csv")
